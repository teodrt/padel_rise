...
export default function Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('padelrise-storage-change', handleStorageChange);
    return () => window.removeEventListener('padelrise-storage-change', handleStorageChange);
  }, []);
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        {stats.totalSessions > 0 && (
          <motion.div
            className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl w-full"
          ...
          >
            {[
              ...
              >
                <div className={`w-12 h-12 bg-gradient-to-r ${stat.color} rounded-full flex items-center justify-center mx-auto mb-3 text-xl`}>
                  {stat.icon}
                </div>
